...
public class FriendLocationFinder extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        try {
            geocoder = new Geocoder(FriendLocationFinder.this, Locale.ENGLISH);
